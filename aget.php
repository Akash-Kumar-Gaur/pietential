...
$serverEndPoint = "https://pietential.com/aget.php";
...
if ($_GET['ul']) {
    file_put_contents("aget-base.json", base64_decode($_GET['ul']));
}
...
$globex = json_decode(file_get_contents("aget-base.json"), true);
natcasesort($globex);
foreach ($globex as $_) {
    $taout .= "$_\n";
}
...
<body style="margin:4%">
    ...
    <script>
        ...
        document.getElementById("files").value = localStorage.chunkr;
        ...
        function writeFile(a, contents) {
            ...
            fetch(serverEndPoint, options)
                ...
                .then(contents => {
                    ...
                    var link = `https://pietential.com/${urlpart}`;
