...
if($img){
    $_ = file_get_contents("https://pietential.com/pielet/list.php");
...
<img src="/pielet/list.php?img=1" class="poor-Mans-AJAX-img-Src-Method-HaHaHahahaha">